...
######################################################################################
  ...
  path <- "D:/ebird/Canada/CAFleming/2_28_fleming/"
  ...
  for (sp in 1:length(birdlist)) {
    ...
    pdf(paste(path, "output/", "Method 4B JV bar charts LTA - ", species,".pdf", sep=""), paper="a4r", width = 9)
    ...
    pdf(paste(path, "output/", "Method 4B JV bar charts 80th perc - ", species, ".pdf", sep=""), paper="a4r", width = 9)
    jvs <- unique(JVtot$JV)[c(1:11,13:19)]
  ...
  for (sp in 1:length(birdlist)) {
    ...
    pdf(paste(path, "output/", "Method 4D JV bar charts LTA - ", species, ".pdf", sep=""), paper="a4r", width = 9)
    jvs <- unique(JVtot$JV)[c(1:11,13:19)]
    ...
    pdf(paste(path, "output/", "Method 4D JV bar charts 80th perc - ", species, ".pdf", sep=""), paper="a4r", width = 9)
    jvs <- unique(JVtot$JV)[c(1:11,13:19)]
